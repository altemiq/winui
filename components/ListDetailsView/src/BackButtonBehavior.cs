// -----------------------------------------------------------------------
// <copyright file="BackButtonBehavior.cs" company="Altemiq">
...
public enum BackButtonBehavior
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>If the back button controlled by <see cref="Windows.UI.Core.SystemNavigationManager"/> is already visible, the <see cref="ListDetailsView"/> will hook into that button.</para>
    /// <para>If the new NavigationView provided by the Windows UI NuGet package is used, the <see cref="ListDetailsView"/> will enable and show that button.</para>
    /// <para>Otherwise the inline button is used.</para>
    /// </remarks>
    Automatic,
